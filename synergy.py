...
import code.reward_2 as reward2
import mods
from teaming.learnsnrg import learner
...
def make_env(nagents):
    ...
    sim.data["Reward Function"]=reward2.assignD2
...
def test1(trial,k,n,train_flag):
    ...
    for i in range(4001):
        ...
        if i%50==0:
            ...
            controller.save("tests/vary/"+str(k)+"-"+str(n)+"-"+str(trial)+"-"+str(train_flag)+"nrg.pkl")
